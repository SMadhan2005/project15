                    ...
                    <tr>
                        ...
                        <?php
                            ...
                            <a class="expolre approval" href="foodedit.php?id=<?php echo $r1['id'];?>&hotelname=<?php echo $r1['hotelname'];?>">Cancel</a><br><br>
                                ...
                                ?>
                                <a href="feed1.php?fid=<?php echo $r1['id'];?>&fname=<?php echo $r1['fname'];?>&customer=<?php echo $r1['customer'];?>">Feedback</a>
...
<div class="related-posts">
                    ...
                    <?php
                $k = 1;
                $q2 = mysqli_query($connect, "SELECT * FROM tbl_feedback WHERE customer='$username'");

                while ($r1 = mysqli_fetch_array($q2)) {
                    $q3 = mysqli_query($connect, "SELECT * FROM tbl_hotelfood WHERE hotelname='" . $r1['hotelname'] . "' AND fname='" . $r1['foodname'] . "'");
                    $r2 = mysqli_fetch_array($q3);
                    ?>
					<div class="related-post">
						<div class="related-post-left">
							<a href=""><img src="<?php echo $r2['file'];?>" alt=" " class="img-responsive"></a>
						</div>
						<div class="related-post-right">
							<h4><a href="">Hotel - <?php echo $r1['hotelname'];?></a></h4>
							<p><?php echo $r1['feed'];?>
							</p>
						</div>
						<div class="clearfix"> </div>
