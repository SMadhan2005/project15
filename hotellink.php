				  ...
				  <!-- /sidebar -->
				          <div id="sidebar"> 
						     <h4 class="menu">Menu</h4>
						          <ul>
							    <li><a href="hotel.php">Canteen <i class="glyphicon glyphicon-triangle-bottom"> </i> </a>
							      <ul>
									  <li><a href="addfood.php"><span>Food</span></a></li>
									 
								   </ul>
                                   <li><a href="#">Booking <i class="glyphicon glyphicon-triangle-bottom"> </i> </a>

                                   <ul>
									  <li><a href="bookingdet1.php">Food Booking<span></span></a></li>
							   ...
							   <li><a href="#">Report <i class="glyphicon glyphicon-triangle-bottom"> </i> </a>
								...
								<ul>
								<li><a href="cusreport1.php">My Report<span></span></a></li>
